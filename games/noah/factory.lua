...
-- constants
NOAH.FACTORY.NO_TILE = 48
NOAH.FACTORY.NO_OBJ  = 0

NOAH.FACTORY.PREFABS =
{
...
NOAH.FACTORY.THINGS =
{
  ...
  -- enemies
  goat     = { kind="monster", r=30, h=60,
              id={ easy=111, medium=111, hard=111, dirs=false },
            },
  sheep   = { kind="monster", r=30, h=60,
              id={ easy=108, medium=108, hard=108, dirs=false, patrol=4 },
            },
  ostrich = { kind="monster", r=30, h=60,
              id={ easy=109, medium=109, hard=109, dirs=false, patrol=4 },
            },
  antelope = { kind="monster", r=30, h=60,
              id={ easy=128, medium=128, hard=128, dirs=false, patrol=4 },
            },
  bull  = { kind="monster", r=30, h=60,
              id={ easy=130, medium=130, hard=130, dirs=false, patrol=4 },
            },

  -- bosses
  carl_camel     = { kind="monster", id=131, r=30, h=60 },
  ginny_giraffe  = { kind="monster", id=115, r=30, h=60 },
  melvin_monkey  = { kind="monster", id=114, r=30, h=60 },
  kerry_kangaroo = { kind="monster", id=134, r=30, h=60 },
  ernie_elephant = { kind="monster", id=135, r=30, h=60 },
  burt_bear      = { kind="monster", id=118, r=30, h=60 },
  
  -- pickups
  k_yellow = { kind="pickup", id=39, r=30, h=60, pass=true },
  k_blue   = { kind="pickup", id=40, r=30, h=60, pass=true },

  small_bandaid = { kind="pickup", id=43, r=30, h=60, pass=true },
  large_bandaid = { kind="pickup", id=44, r=30, h=60, pass=true },

  feed         = { kind="pickup", id=45, r=30, h=60, pass=true },
  slingshot_2 = { kind="pickup", id=46, r=30, h=60, pass=true },
  slingshot_3 = { kind="pickup", id=47, r=30, h=60, pass=true },
  slingshot_4 = { kind="pickup", id=55, r=30, h=60, pass=true },
  slingshot_5 = { kind="pickup", id=57, r=30, h=60, pass=true },

  banana    = { kind="pickup", id=48, r=30, h=60, pass=true },
  red_apple = { kind="pickup", id=49, r=30, h=60, pass=true },
  grapes    = { kind="pickup", id=50, r=30, h=60, pass=true },
  peach     = { kind="pickup", id=51, r=30, h=60, pass=true },
  one_up    = { kind="pickup", id=52, r=30, h=60, pass=true },

  -- scenery
  barrel = { kind="scenery", id=26, r=30, h=60 },

  puddle         = { kind="scenery", id=23, r=30, h=60, pass=true },
  candle         = { kind="scenery", id=38, r=30, h=60, light=255 },
  chandelier     = { kind="scenery", id=36, r=30, h=60, light=255, pass=true, ceil=true, add_mode="island" },
  slender_column = { kind="scenery", id=31, r=30, h=60, add_mode="island" },

  tree  = { kind="scenery", id=31, r=30, h=60 },
  sink  = { kind="scenery", id=33, r=30, h=60, add_mode="extend" },

  bare_table = { kind="scenery", id=25, r=30, h=60, add_mode="island" },

  bird_cage = { kind="scenery", id=32, r=30, h=60, add_mode="island" },

  bed    = { kind="scenery", id=45, r=30, h=60 },
  basket = { kind="scenery", id=46, r=30, h=60 },

  debris = { kind="scenery", id=27, r=30, h=60, pass=true },
  bible_quiz = { kind="scenery", id=28, r=30, h=60, pass=true },
...
NOAH.FACTORY.QUESTS =
{
  key = { k_yellow=60, k_blue=30, },

  switch = { },

  weapon = { slingshot_3=50, slingshot_4=20, },

  item =
  {
    banana = 50, red_apple = 50, grapes = 50, peach = 50,
    one_up = 2,
  },
...
NOAH.FACTORY.ROOMS =
{
  ...
  TREASURE =
  {
    pickups = { banana=90, red_apple=90, grapes=20, peach=5 },
    pickup_rate = 90,
  },
  ...
  SUPPLIES =
  {
    ...
    pickups = { large_bandaid=50, small_bandaid=90, feed=70 },
    pickup_rate = 66,
  },

  QUARTERS =
  {
    scenery = { bare_table=70, chandelier=70,
                puddle=20, candle=10
              },
  },
}
...
NOAH.FACTORY.MONSTERS =
{
  goat     = { prob=20, hp=1,   dm=5,  fp=1.0, melee=true, },
  sheep    = { prob=60, hp=25,  dm=10, fp=1.0, hitscan=true, cage_fallback=10 },
  ostrich  = { prob=30, hp=50,  dm=20, fp=1.7, hitscan=true, },
  antelope = { prob=10, hp=55,  dm=35, fp=1.9, hitscan=true, },
  bull     = { prob=60, hp=100, dm=30, fp=1.4, hitscan=true, },
}

NOAH.FACTORY.BOSSES =
{
  -- No idea what these stats should be

  carl_camel     = { hp=1000, dm=50, hitscan=true },
  ginny_giraffe  = { hp=1000, dm=50, hitscan=true },
  melvin_monkey  = { hp=1000, dm=50, hitscan=true },
  kerry_kangaroo = { hp=1000, dm=50, hitscan=true },
  ernie_elephant = { hp=1000, dm=50, hitscan=true },
  burt_bear      = { hp=1000, dm=50, hitscan=true },
}

NOAH.FACTORY.MONSTER_GIVE =
{
  -- No idea

  sheep   = { { ammo="feed", give=4 } },
  ostrich = { { ammo="feed", give=4 } },
  antelope  = { { ammo="feed", give=4 } },
}

NOAH.FACTORY.WEAPONS =
{
  hand_feed   = { fp=0, melee=true,  rate=3.0, dm= 7, freq= 2, held=true },
  slingshot_2 = { fp=1, ammo="feed", per=1, rate=3.0, dm=17, freq=10, held=true },

  slingshot_3 = { fp=2, ammo="feed", give=4, per=1, rate=8.0,  dm=17, freq=30, },
  slingshot_4 = { fp=3, ammo="feed", give=6, per=1, rate=16.0, dm=17, freq=90, },
}

NOAH.FACTORY.PICKUPS =
{
  large_bandaid = { stat="health", give=25 },
  small_bandaid = { stat="health", give=10 },

  -- NOTE: no "gibs" here, they are fairly insignificant

  feed  =   { stat="feed", give=8 },
}

NOAH.FACTORY.INITIAL_MODEL =
{
  noah =
  {
    health=100, armor=0, feed=8,
    hand_feed=true, slingshot_2=true
  }
}
...
function NOAH.decide_quests(level_list, is_spear)

  local function add_quest(L, kind, item, secret_prob, ob_size)
    secret_prob = 0 --FIXME !!!!

    local len_probs = non_nil(NOAH.FACTORY.QUEST_LEN_PROBS[kind])
    local Quest =
    {
      kind = kind,
      item = item,
  ...
  for zzz,Level in ipairs(level_list) do
    ...
    if rand.odds(90 - 40 * ((Level.ep_along-1) % 3)) then
      add_quest(Level, "weapon", "slingshot_3", 35, ob_size)
    end

    if gatling_maps[Level.ep_along] then
      add_quest(Level, "weapon", "slingshot_4", 50, ob_size)
    end

    local keys = math.round(ob_size / 25)

    if keys >= 1 then
      add_quest(Level, "key", "k_yellow", 0, ob_size)
    end
    ...
    elseif keys == 2 then
      add_quest(Level, "key", "k_blue", 0, ob_size)
    end
...
function NOAH.get_factory_levels(episode)

  local level_list = {}

  local theme_probs = NOAH.FACTORY.EPISODE_THEMES[episode]

  local boss_kind = NOAH.FACTORY.EPISODE_BOSSES[episode]
  if OB_CONFIG.length ~= "full" then
    boss_kind = NOAH.FACTORY.EPISODE_BOSSES[rand.irange(1,6)]
  end
  ...
  for map = 1,10 do
    ...
    if NOAH.FACTORY.SECRET_EXITS[Level.name] then
  ...
  local function dump_levels()
    for idx,L in ipairs(level_list) do
      gui.printf("Super Noah's Ark 3D episode [%d] map [%d] : %s\n", episode, idx, L.name)
      show_quests(L.quests)
    end
  end

  NOAH.decide_quests(level_list)
...
function NOAH.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    TILE_NUMS = NOAH.FACTORY.TILE_NUMS,
    NO_TILE = NOAH.FACTORY.NO_TILE,
    NO_OBJ = NOAH.FACTORY.NO_OBJ,
    ...
    episodes = 6,
    level_func = NOAH.get_factory_levels,

    classes  = { "noah" },

    things     = NOAH.FACTORY.THINGS,
    monsters   = NOAH.FACTORY.MONSTERS,
    bosses     = NOAH.FACTORY.BOSSES,
    mon_give   = NOAH.FACTORY.MONSTER_GIVE,
    weapons    = NOAH.FACTORY.WEAPONS,

    pickups = NOAH.FACTORY.PICKUPS,
    pickup_stats = { "health", "feed" },

    initial_model = NOAH.FACTORY.INITIAL_MODEL,

    quests  = NOAH.FACTORY.QUESTS,

    dm = {},

    combos    = NOAH.FACTORY.COMBOS,
    exits     = NOAH.FACTORY.EXITS,
    hallways  = nil,

    doors     = NOAH.FACTORY.DOORS,
    key_doors = NOAH.FACTORY.KEY_DOORS,

    rooms     = NOAH.FACTORY.ROOMS,
    themes    = NOAH.FACTORY.THEMES,

    misc_fabs = NOAH.FACTORY.MISC_PREFABS,
  ...
  GAME.FACTORY.PREFABS = NOAH.FACTORY.PREFABS
