...
-- constants
WOLF.FACTORY.NO_TILE = 48
WOLF.FACTORY.NO_OBJ  = 0

WOLF.FACTORY.PREFABS =
{
...
function WOLF.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    TILE_NUMS = WOLF.FACTORY.TILE_NUMS,
    NO_TILE = WOLF.FACTORY.NO_TILE,
    NO_OBJ = WOLF.FACTORY.NO_OBJ,

    ERROR_TEX  = WOLF.FACTORY.NO_TILE,
    ERROR_FLAT = 99, -- dummy
    SKY_TEX    = 77, -- dummy

    episodes = 6,
    level_func = WOLF.get_factory_levels,

    classes  = { "bj" },

    things     = WOLF.FACTORY.THINGS,
    monsters   = WOLF.FACTORY.MONSTERS,
    bosses     = WOLF.FACTORY.BOSSES,
    mon_give   = WOLF.FACTORY.MONSTER_GIVE,
    weapons    = WOLF.FACTORY.WEAPONS,

    pickups = WOLF.FACTORY.PICKUPS,
    pickup_stats = { "health", "bullet" },

    initial_model = WOLF.FACTORY.INITIAL_MODEL,

    quests  = WOLF.FACTORY.QUESTS,

    dm = {},

    combos    = WOLF.FACTORY.COMBOS,
    exits     = WOLF.FACTORY.EXITS,
    hallways  = nil,

    doors     = WOLF.FACTORY.DOORS,
    key_doors = WOLF.FACTORY.KEY_DOORS,

    rooms     = WOLF.FACTORY.ROOMS,
    themes    = WOLF.FACTORY.THEMES,

    misc_fabs = WOLF.FACTORY.MISC_PREFABS,
  ...
  GAME.FACTORY.PREFABS = WOLF.FACTORY.PREFABS
